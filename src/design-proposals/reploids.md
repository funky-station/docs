...
- The ‘meat’ that is gained from them should be called `“Synthflesh”`, as well should the organs be flavortexted as `"Synthetic [Organ"]`.I will suggest copper-based, horseshoe-crab-esque blue blood for them, as it further visually differentiates them from the baseline and makes it apparent upon damage what they are by default. [If the "Synthetic" trait gets added, I will isntead lobby for this to be attached to the species permanently]
...
| Artificial beings grown in vats to help stabilize colony workforce numbers on planets with poor supply chains or excessively harsh conditions, from batches upon batches of donor imprints from people of all walks of life. They have established themselves and new colonies in the name of their donors over the last few centuries, and have since become a welcome presence amongst many locations, albeit with scrutiny from those who view them as wholly unnatural. |
|---|
