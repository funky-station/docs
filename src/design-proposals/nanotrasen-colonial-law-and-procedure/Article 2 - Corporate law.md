...
### Personnel Searches
Security personnel are allowed to search personnel under any of the following conditions:
1. There is reasonable suspicion of a crime.
2. There is a search warrant for the being.
3. The station’s alert level allows for random searches.

The search allows the seizure of any illegal possessions. This includes any bags, boxes or other containers the person has in the immediate vicinity.
...
### Department searches
Security personnel are allowed to search a department under any of the following conditions:
...
The Executive Officer may issue ID cards with temporary access for the purposes of fulfilling a search warrant.
...
Security Personnel are allowed to arrest only with probable cause of a crime.
Arrest reasons include, but are not limited to:
- Directly witnessing a crime.
- Having suitable forensic evidence of a crime.
- Eyewitness report from a trustworthy individual.
...
- The subject poses a clear threat towards privileged individuals, Security personnel, and/or station assets
- The subject is non-cooperative, or resisting enforcement authority.
...
## 5. Treatment of Arrestees and Prisoners
Personnel in custody are to be ensured the following rights:

### Arrestees
Arrestees must be provided with:
...
## 6. Implantation
Any crew member can be implanted if they give their clear permission.

Any prisoner in custody can be subjected to implantation or implant removal procedures, so long as it's within reason. The process of adding an implant should not prolong the arrestee's sentence.

### Implantation
If a suspect or prisoner represents a flight risk, or is a recurring offender, a tracking implant can be administered to them.
...
Unlike the implantation procedure, a prisoner can have their sentence entirely delayed or extended until they comply with the removal, as long as Security are actively making attempts to perform it. Akin to implanting, if an inmate gives their clear permission, implant removal can proceed without proof.
...
| Vandalism (D) |  | Destruction of Property (D) |  |  | Mass Destruction (D) |  |  | Station Sabotage (D) |  |
...
| Operation without Permit (O) |  | Smuggling (O) |  | Black Marketeering (O) |  |  |  |  |  |
...
|  |  | Assault (V) | Battery (V) |  | Mutilation (V) |  | Murder (V) | Prevention of Revival (V) |  |
...
| Misdemeanor (C) | Trespass | Entering a restricted area without express permission. |
| Felony (C) | Secure Trespass | Entering a station-critical restricted area without express permission. |
...
| Misdemeanor (C) | Possession of Moderate Contraband | See Contraband Classifications. |
| Felony (C) | Possession of Major Contraband | See Contraband Classifications. |

| D | Destruction | Causing intentional damage to station functions. |
| :---- | :---- | :---- |
| Infraction | Vandalism | Superficially damaging or defacing station property. |
| Misdemeanor (B) | Destruction of Property | Causing substantial structural damage, requiring repairs. |
| Felony (B) | Mass Destruction | Causing substantial structural damage to a large area of the station. |
| Capital Offense (B) | Station Sabotage | Intentionally rendering critical station infrastructure inoperable. |
...
| Misdemeanor (C) | Slander | Speaking false and harmful statements about NanoTrasen, its subsidiaries, or contractees. |
| Misdemeanor (B) | Impersonation | Hiding your true identity and posing as someone you are not for personal gain. |
| Felony (C) | Libel | Publishing false and harmful written statements about NanoTrasen, its subsidiaries, or contractees. |
| Felony (B) | Fraud | Intentionally lying about promised actions for personal gain, or not following through with non-NT contracts. |
| Capital Offense (C) | Impersonation of Central Command | Hiding your true identity and posing as Central Command. |

| J | Obstruction of Legal Justice | Impeding or abusing the legal justice system. |
| :---- | :---- | :---- |
| Misdemeanor (B) | Contempt of Court | Needlessly interrupting or delaying official court proceedings. |
| Felony (C) | Perjury | Lying under oath of court, or delivering false reports to Security. |
| Felony (A) | Subversion of Court | Obstructing court to the point where official court proceedings have to pause or stop altogether. |

| M | Manipulation | Manipulating a sapient being through tactics of fear and/or aggression. |
| :---- | :---- | :---- |
...
| Felony (C) | Extortion | Unlawfully forcing another sapient being to do something unwillingly, by means of threats, force or aggression. |
| Felony (A) | Sedition | Conspiring to overthrow or otherwise dismantle NanoTrasen public trust and authority. |
| Capital Offense (A) | Terrorism | Causing mass station panic, or completely disrupting station operations by means of fear and/or lethal force. |

| N | Negligence | Causing harm to the station or its crew through vocational incompetence. |
| :---- | :---- | :---- |
| Infraction | Negligence | Unintentionally performing an action in a way that creates unnecessary harm. |
| Misdemeanor (B) | Endangerment | Willfully performing an action in a way that creates unnecessary harm. |
| Felony (B) | Manslaughter | Killing another sapient being without intent. |
| Capital Offense (C) | Capital Negligence | Performing an action in a way that causes unnecessary harm, to the point of causing mass station destruction, or rendering a department mostly inoperable, even temporarily. |

| O | Operation | Performing works or transactions not sanctioned by NanoTrasen. |
| :---- | :---- | :---- |
...
| Misdemeanor (B) | Smuggling | Illegaly distributing or selling items outside of the NT ecosystem |
| Felony (C) | Black Marketeering | Engaging in the buying and/or selling of contraband. |
...
| Misdemeanor (B) | Unlawful Assembly | Refusing to disperse a protest or gathering after an official and legal declaration to do so has been issued. |
| Felony (B) | Rioting | Participating in unlawful protests, in the case where violence or station damages occur. |
...
| Misdemeanor (B) | Breach of Arrest | Escaping from or evading a lawful and justified arrest or detainment. |
| Felony (C) | Breach of Custody | Escaping from custody during or after receiving a legal sentence. |
...
| Misdemeanor (C) | Theft | Taking something of meaningful value. |
| Felony (C) | Grand Theft | Taking something that is critical to the person’s job or role. |

| V | Intentional Violence | Causing intentional bodily harm to another sapient being. |
| :---- | :---- | :---- |
| Misdemeanor (B) | Assault | Threatening or attempting to cause bodily harm to another sapient being. |
| Misdemeanor (A) | Battery | Causing superficial bodily harm to another sapient being. |
| Felony (B) | Mutilation | Causing permanent or otherwise long-lasting damage to another sapient being’s body parts, organs, or appendages. |
| Capital Offense (C) | Murder | Intentionally killing another sapient being. |
| Capital Offense (B) | Prevention of Revival | Rendering a dead body unrevivable by common medical practice. |

| W | Free Will | Depriving another sapient being of their free will and autonomy. |
| :---- | :---- | :---- |
| Felony (B) | Kidnapping | To unlawfully restrain or transport another sapient being against their will. |
| Capital Offense (B) | Suppression of Free Will | Permanently depriving another sapient being of their free will and autonomy. |
...
| Misdemeanor (B) | Failure to Pay | Failure to pay a legally imposed fine within the required timeframe. |
| Misdemeanor (A) | Animal Cruelty | Inflicting excessive harm on a living being, except when required for medical treatment, scientific research, or the preparation of food. |
| Felony (B) | Bribery | Offering, giving or accepting gifts, money, or favors to influence someone to act outside of their allowed duties. |
| Felony (A) | Tax Evasion | Not paying NanoTrasen-mandated scrip taxes, or using non-scrip currencies to avoid paying taxes. |
| Capital Offense (B) | Refusal of Lawful Implantation | Refusing to accept a lawful implant from Security personnel while in custody. |
| Capital Offense (A) | Breach of NT Contract | Violating the terms of an NT-issued, signed contract. |

---

## 8. Contraband Classifications

### Contraband Confiscation Procedures
...
Security personnel are to avoid unreasonable confiscation of items in order to maintain positive public relations between Security, privileged individuals, and the rest of the station's crew.
...
Minor: Items that carry branding from Non-NT organizations, with low-risk of exposure to other crew.
...
- The pranks do not cause bodily harm.
- Damages caused are reversed at the end of the bit.
- In case the clown gets taken to court, the presiding judge determines if the bit was funny and if the clown exception holds.

### Loss of Free Will
In the event that a sapient being is under the influence of effects that completely suppress or control the being’s free will, any charges should be dropped upon the removal of said influence.
