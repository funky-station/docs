...
They were a highly social species that would communicate using toots and snores in order to warn each other or advertise good grazing grounds. 
...
Galphzzzeb DO NOT USE THEIR TRUNK TO BREATHE. They have a small breathing flap under the trunk which they use to absorb water vapor, as such they can wear medical or emergency masks.
Wearing a breathing or medical mask allows for the use of the trunk as it is not the breathing organ.
...
The 320 degree vision feature will only come into effect if vision cones are ever implemented and may lead to balance concerns.
